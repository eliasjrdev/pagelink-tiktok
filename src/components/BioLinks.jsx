...
const links = [
  ...
  { icon: <FaRobot />, label: 'Acesse a Manus AI aqui', url: 'https://manus.im/redeem?c=EJ2D6A53' },
  { icon: <FaRobot />, label: 'Acesse a TRAE SOLO aqui', url: 'https://www.trae.ai/?utm_source=influencerglobal&utm_medium=voyager&utm_campaign=eliasjr.dev' },
